...
public:
    ...
    int GetTileIndexForTilePos(Vector2Int tilePos);
    int GetTileIndexForWorldPos(Vector2 worldPos);
    Vector2Int GetTilePosForTileIndex(int tileIndex);
    Vector2Int GetTilePosForWorldPos(Vector2 worldPos);
    Vector2 GetWorldPosForTileIndex(int tileIndex);
    Vector2 GetWorldPosForTilePos(Vector2Int tilePos);
    bool IsTileWalkableForWorldPos(Vector2 worldPos);
    bool IsTileWalkableForTilePos(Vector2Int tilePos);
